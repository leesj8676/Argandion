...
public class UIManager : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        ItemObject item1 = findItem(3);
        acquireItem(item1, 8);
        ItemObject item2 = findItem(12);
        acquireItem(item2, 11);
        ItemObject item3 = findItem(10);
        acquireItem(item3, 71);
        ItemObject item4 = findItem(21);
        acquireItem(item4, 21);
        ItemObject item5 = findItem(300);
        acquireItem(item5, 1);

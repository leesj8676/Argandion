...
public class UIManager : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        ItemObject item1 = findItem(51);
        acquireItem(item1, 5);
        // ItemObject item2 = findItem(3);
        // acquireItem(item2, 12);
        // ItemObject item3 = findItem(12);
        // acquireItem(item3, 13);
        // ItemObject item4 = findItem(10);
        // acquireItem(item4, 81);
        // ItemObject item5 = findItem(21);
        // acquireItem(item5, 18);

...
public class UIManager : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        ItemObject item1 = findItem(308);
        acquireItem(item1, 1);
        // ItemObject item2 = findItem(2);
        // acquireItem(item2, 30);
        // ItemObject item3 = findItem(3);
        // acquireItem(item3, 42);
        // ItemObject item4 = findItem(10);
        // acquireItem(item4, 37);
        // ItemObject item5 = findItem(11);
        // acquireItem(item5, 13);
        // ItemObject item10 = findItem(55);
        // acquireItem(item10, 14);
        // ItemObject item11 = findItem(56);
        // acquireItem(item11, 15);
        // // 그 외 재료
        // ItemObject item6 = findItem(115);
        // acquireItem(item6, 40);
        // ItemObject item7 = findItem(116);
        // acquireItem(item7, 27);
        // ItemObject item8 = findItem(108);
        // acquireItem(item8, 27);
        // ItemObject item9 = findItem(109);
